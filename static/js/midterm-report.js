document.addEventListener('DOMContentLoaded', function () {
    ...
    generateReportBtn.addEventListener('click', function (e) {
        ...
        Swal.fire({
            title: 'Generate Midterm Report?',
            text: `Do you want to generate a midterm report for ${studentName} in ${selectedTerm}?`,
            icon: 'info',
            ...
            if (result.isConfirmed) {
                ...
                fetch('/reports/generate_midterm_report/', {
                    method: 'POST',
                    headers: {
                    ...
                    .then(data => {
                        if (data.success && data.report_html) {
                            ...
                            reportWindow.document.write('<html><head><title>MidTerm Report</title></head><body>');
