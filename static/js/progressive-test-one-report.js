document.addEventListener('DOMContentLoaded', function () {
    ...
    generateReportBtn.addEventListener('click', function (e) {
        ...
        Swal.fire({
            title: 'Generate Progressive Test One Report?',
            text: `Do you want to generate a progressive test one report for ${studentName} in ${selectedTerm}?`,
            icon: 'info',
            ...
            if (result.isConfirmed) {
                ...
                fetch('/reports/generate_progressive_one_report/', {
                    method: 'POST',
                    headers: {
                    ...
                    .then(data => {
                        if (data.success && data.report_html) {
                            ...
                            reportWindow.document.write('<html><head><title>Progressive Test One Report</title></head><body>');
