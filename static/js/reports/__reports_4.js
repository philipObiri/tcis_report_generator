            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            // Use Swal.getPopup() to get elements from the modal
                            ...
                            if (selectedTerm === 'Term 3') {
                                ...
                                if (promotionSelect) {
                                    ...
                                    console.log('Selected promotion:', promotion); // Debug log
                                } else {
                                    console.log('Promotion select element not found in popup!');
                                }
                            }
                            ...
                            console.log('Sending data:', { academic_comment, behavioral_comment, promotion }); // Debug log
                        ...
                        $.ajax({
                            ...
                            data: JSON.stringify({
                                ...
                                promotion: promotion || ''  // Ensure it's never undefined
                            }),
